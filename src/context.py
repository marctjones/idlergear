...
class ProjectContext:
    ...
    def read_charter_documents(self) -> Dict[str, str]:
        ...
        charter_docs = ['VISION.md', 'DESIGN.md', 'TODO.md', 'IDEAS.md', 'DEVELOPMENT.md', 'ARCHITECTURE.md', 'ROADMAP.md']
        docs = {}
    ...
    def get_project_structure(self) -> str:
        ...
        try:
            for item in sorted(root.iterdir()):
                ...
                if item.name.startswith('.') or item.name in ['venv', 'node_modules', '__pycache__', 'target', 'build', 'dist']:
                    continue
    ...
    def format_context(self, include_docs: bool = True, include_activity: bool = True, 
                      include_structure: bool = True, format_type: str = "markdown") -> str:
        """Format complete project context."""
        
        if format_type == "markdown":
            return self._format_markdown(include_docs, include_activity, include_structure)
        elif format_type == "plain":
            return self._format_plain(include_docs, include_activity, include_structure)
        else:
            return self._format_markdown(include_docs, include_activity, include_structure)
    
    def _format_markdown(self, include_docs: bool, include_activity: bool, include_structure: bool) -> str:
    ...
    def _format_plain(self, include_docs: bool, include_activity: bool, include_structure: bool) -> str:
